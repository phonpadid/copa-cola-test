<template>
  <div class="base-menu-table">
    ...
    <ModalManageReRunSMS :visible="modalVisible" @change="(val) => modalVisible = val"/>
  </div>
</template>
...
import ModalManageReRunSMS from "@/views/pages/re-run-AllReport/reRunSMS/TabItems/manage.vue"
