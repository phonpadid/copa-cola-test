<template>
  <div class="base-menu-table">
    ...
    <SMSCDRsModal :visible="modalVisibleSMSCDRs" @change="(val) => modalVisibleSMSCDRs = val"/>
  </div>
</template>
...
import SMSCDRsUseCase from "@/usecases/SMSCDRsUseCase";
import SMSCDRsModal from "@/views/pages/CDRsExport/SMSCDRs/TabItems/manage.vue"
