<template>
  <div class="base-menu-table">
    ...
    <VoiceCDRsModal :visible="modalVisibleVoiceCDRs" @change="(val) => modalVisibleVoiceCDRs = val"/>
  </div>
</template>
...
import VoiceCDRsModal from "@/views/pages/CDRsExport/voiceCDRs/TabItems/manage.vue"

const {
  onCreate,
  modalVisibleVoiceCDRs,
} = VoiceCDRsUseCase;
