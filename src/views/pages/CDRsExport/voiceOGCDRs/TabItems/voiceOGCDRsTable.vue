<template>
  <div class="base-menu-table">
    ...
    <VoiceOGCDRsModal :visible="modalVisibleVoiceOGCDRs" @change="(val) => modalVisibleVoiceOGCDRs = val"/>
  </div>
</template>
...
import VoiceOGCDRsUseCase from "@/usecases/voiceOGCDRsUseCase";
import VoiceOGCDRsModal from "@/views/pages/CDRsExport/voiceOGCDRs/TabItems/manage.vue"

const {
  onCreate,
  modalVisibleVoiceOGCDRs,
} = VoiceOGCDRsUseCase;
