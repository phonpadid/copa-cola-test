<template>
  <div class="base-form flex justify-center items-center">
    <div class="w-[800px] min-h-[500px] px-16 pt-4 flex flex-col">
      <div class="w-full text-blue-600 font-black hover:cursor-pointer hover:text-blue-600  text-3xl">
        <span @click="changeToMainEvent">  <i class="far fa-long-arrow-left"></i> Event Detail</span>
      </div>
      <h1 class="text-xl mt-4 font-bold">Event Name</h1>
