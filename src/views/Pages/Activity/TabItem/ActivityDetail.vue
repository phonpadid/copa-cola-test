<template>
  <div class="base-form flex justify-center items-center">
    <div class="w-[800px] min-h-[500px] px-10 pt-4 flex flex-col">
      <div
      ...
      <div class="w-full flex flex-col min-h-[80px] mt-4">
        ...
        <div class="w-full flex flex-wrap  h-auto mt-4">
      ...
      <div class="w-full flex flex-col min-h-[80px] mt-4">
        ...
        <a-row :gutter="[12,12]">
          <a-col :sm="24" :md="12" :lg="12" v-for="item in activityDetail.posts">
