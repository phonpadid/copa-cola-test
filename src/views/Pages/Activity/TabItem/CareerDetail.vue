<template>
  <div class="base-form flex justify-center items-center">
    <div class="w-[800px] min-h-[500px] px-16 pt-4 flex flex-col">
      ...
      <div
        class="w-[300px] flex items-center justify-center rounded-full overflow-hidden h-[300px] bg-gray-200"
      >
        <img
      ...
      <div class="w-full flex flex-col min-h-[80px] mt-4">
        ...
        <div class="w-full flex h-[40px] mt-4">
          ...
          <div
            v-for="person in careerDetail.personals_active"
            :key="person"
...
function fetchCareerDetail() {
  ...
  store
    .dispatch("data-resources/listing", {
      ...
      options_request: bodyHelpers([{ type: "career" }])
    })
    .then(res => {
      if (res.code === 200) {
